...
const testimonials = () => {
  ...
  const reviews = [
    ...
    { image: Alia, review: 'isOdd takes away the pain of doing all the math of trying to understand whether a number is odd, life saver.', author: 'Alia Dohrmann - Ruby Developer' },
